...
<div class="row justify-content-md-center">
    <div class="col-8">
        <form action="<?php echo e(url("animales")); ?>" method="post">
            ...
            <div class="form-group">
                ...
                <select name="id_ganadero" id="id_ganadero">
                    <?php $__currentLoopData = $ganaderos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ganadero): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($ganadero->id_ganadero); ?>" ><?php echo e($ganadero->usuario); ?></option>
            ...
            <div class="form-group">
                ...
                <select name="id_tipoganado" id="id_tipoganado">
                    <?php $__currentLoopData = $tganados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ganado): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($ganado->id_tipoganado); ?>" ><?php echo e($ganado->desc_ganado); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
