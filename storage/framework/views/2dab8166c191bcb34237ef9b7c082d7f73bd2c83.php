...
<header class="bg-secondary" >
    <span class="text-center font-italic"><font color="#f0f8ff"><h1 class="text-capitalize text-xl-center">Registro de Usuario</h1></font>
    </span>
</header>
    ...
    <div class="col-8" align="left">
        <form action="" method="post">
            ...
            <div class="form-group">
                ...
                <input type="password" id="descripcion" name="descripcion" class="form-text"  placeholder="Contraseña">

                <label for="Contraseña" >Confirmar Contraseña</label>
                <input type="password" id="descripcion" name="descripcion" class="form-text"  placeholder="Confirmar Contraseña">
            </div>
            <button type="submit" class="btn btn-group btn-danger"><i class="fa fa-save"> Guardar</i></button>
        </form>
    </div>
</div>
<br>
